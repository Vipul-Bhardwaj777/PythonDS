...
res = client.chat.completions.create(
    ...
    messages=[
        {'role':'system','content':'You are an expert in maths only answer maths related questions. And if the question is not related to maths just say sorry and dont answer'},
